...
// Append, don't replace — Expo's default watchFolders (added in
// SDK 55+) include internal paths that `expo-doctor` checks for.
// Replacing them trips the "watchFolders does not contain all
// entries from Expo's defaults" warning.
