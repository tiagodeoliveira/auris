...
struct PermissionsView: View {
    ...
    var body: some View {
        SettingsTabShell(
            title: "Permissions",
            description: "System permissions required to capture meeting audio. macOS opens its own panel for granting; the status here reflects whatever you choose there."
        ) {
            Form {
                Section {
                    permissionRow(
