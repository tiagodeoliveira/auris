...
//!     assistant turns with two spaces (no cursor). ASCII only — the
//!     glasses LVGL font has no glyph for fancier markers like `▶`,
//!     which render as tofu. `> ` is the same cursor the entry list,
//!     header, and stop sentinel already use.
